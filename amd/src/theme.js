 ...
 */
 ...
 define(['jquery'], function($) {
    ...
    var Themepinoverde = function() {
        this.initialize();
    };

    Themepinoverde.prototype.initialize = function() {

...
$string['backgroundimage_desc'] = 'The image to display as the background for the site\'s theme. <br> <b> Note: </b> The background image works based on the parent theme "Boost". If the background image is deleted in the "Boost" theme, it will also be deleted in our "pinoverde" theme.';
...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><img class=img-polaroid src="pinoverde/pix/screenshot.jpg" /><br/><p></p><h3>Theme Credits</h3><p><h3>Moodle pinoverde theme</h3><p>This theme is based on the Boost Moodle theme.</p><p>Authors: LMSACE Dev Team<br>Contact: info@lmsace.com<br>Website: <a href="http://www.lmsace.com">www.lmsace.com</a><br></p>';
...
$string['footerbtitledesc'] = 'Enter a title for this block as plain text or lang:language_key for multi-lingual support. You can find the theme language keys here: /theme/pinoverde/lang/en/theme_pinoverde.php';
...
$string['privacy:metadata'] = 'The pinoverde theme does not store any personal data about any user.';
...
$string['title'] = 'Title';
$string['titledesc'] = 'To set the title for the this block, enter the block title as plain text or use the "lang" prefix followed by the appropriate "language_key" for multi-lingual support. You can find the theme language keys for multi-lingual support in the "/theme/pinoverde/lang/en/theme_pinoverde.php" file.';

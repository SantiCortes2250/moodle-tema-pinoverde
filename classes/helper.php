...
class helper {
    ...
    public function load_additional_scss_settings() {
        $scss = '';
        $primary = theme_pinoverde_get_setting('primarycolor');
        $secondary = theme_pinoverde_get_setting('secondarycolor');
        $slideoverlayval = theme_pinoverde_get_setting('slideOverlay');
        $slideopacity = (!empty($slideoverlayval)) ? $this->get_hexa('#000000', $slideoverlayval) : 0.4;
        $footerbgoverlayval = theme_pinoverde_get_setting('footerbgOverlay');

        $footerbgopacity = (!empty($footerbgoverlayval)) ? $this->get_hexa($primary, $footerbgoverlayval) : 0.4;
        $pagesizecustomval = theme_pinoverde_get_setting('pagesizecustomval');
        $fontsize = theme_pinoverde_get_setting('fontsize');
    ...
    public function render_slideimg($p, $slidername) {
        ...
        $slideimage = '';
        if (theme_pinoverde_get_setting($slidername)) {

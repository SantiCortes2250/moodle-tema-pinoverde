...
namespace theme_pinoverde\output\core;
...
class course_renderer extends \core_course_renderer {
    ...
    public function include_frontslide_js($blockid) {
        $this->page->requires->js_call_amd('theme_pinoverde/frontpage', $blockid, []);
    }
    ...
    public function frontpage_available_courses() {
        global $CFG;
        $displayoption = theme_pinoverde_get_setting('availablecoursetype');
        if ($displayoption != '1') {
    ...
    public function render_template($template, $data) {
        ...
        return $this->output->render_from_template('theme_pinoverde/course_blocks', $data);
    }
    ...
    public function promoted_courses() {
        ...
        $pcoursestatus = theme_pinoverde_get_setting('pcoursestatus');
        $promotedtitle = theme_pinoverde_get_setting('promotedtitle', 'format_html');
        $promotedtitle = theme_pinoverde_lang($promotedtitle);
        $promotedcoursedesc = theme_pinoverde_lang(theme_pinoverde_get_setting('promotedcoursedesc'));
        $featuredids = theme_pinoverde_get_setting('promotedcourses');
        ...
        if (!empty($featuredids)) {
            ...
            $helperobj = new \theme_pinoverde\helper();
        ...
        return $this->output->render_from_template("theme_pinoverde/course_blocks", $template);
    }
    ...
    public function frontpage() {
        ...
        $output = '';
        $themeblocks = new \theme_pinoverde\pinoverde_blocks();
        ...
        $pinoverdefrontpagelayout = array_merge($beforelayout, $frontpagelayout, $afterlayout);
        foreach ($pinoverdefrontpagelayout as $a) {
            switch($a) {
    ...
    protected function coursecat_category(\coursecat_helper $chelper, $coursecat, $depth) {
        ...
        $combolistboxtype = (theme_pinoverde_get_setting('comboListboxType') == 1) ? true : false;
        if ($combolistboxtype) {
            $classes[] = 'collapsed';
        }
